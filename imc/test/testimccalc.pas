...
uses
  Classes, SysUtils, fpcunit, testutils, testregistry, ImcCalc in '../src/imccalc.pas';
...
begin
  AssertEquals(TImcCalc.CheckSize(''), 'Vous devez donner une taille au format nombre' + sLineBreak);
  AssertEquals(TImcCalc.CheckSize('test'), 'Vous devez donner une taille au format nombre' + sLineBreak);
  AssertEquals(TImcCalc.CheckSize('120cm'), 'Vous devez donner une taille au format nombre' + sLineBreak);
  AssertEquals(TImcCalc.CheckSize('35'), 'Merci de donner une taille comprise entre 50 et 300 cm' + sLineBreak);
  AssertEquals(TImcCalc.CheckSize('350'), 'Merci de donner une taille comprise entre 50 et 300 cm' + sLineBreak);
